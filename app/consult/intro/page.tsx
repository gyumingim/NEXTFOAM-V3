...
const industries = [
    { label: "항공우주", items: "항공기/유도무기 공력 DB 구축, 항공기 외장분리, 무장창 음향하중, 우주발사체 배기 플룸, 발사대 화염유도로, 터보펌프, 로켓 단분리, 초음속 흡입구, 그리드 핀" },
    { label: "자동차/철도차량", items: "헤드램프, 라디에이터, 실내 공조, 제상, 주행 저항, 교행, 측풍, 열차풍, 미기압파, 형상 최적화, 융설, 하이퍼튜브, 스크린도어 풍압, 터널 화재, 배터리" },
    { label: "조선해양", items: "선박 저항/자항, 부가물, 프로펠러 성능/캐비테이션, 선박 운동, 슬로싱, 배가스 확산, 공장 환기, 선박 배관시스템, 파랑 생성, 해양플랜트 라이저, FPSO, 파랑저감장치, 사고 분석" },
    { label: "건설/토목", items: "건축물 풍압, 풍환경, 연돌 현상, 교량, 댐 여수로, 빗물 터널, 환기" },
    { label: "전기/전자", items: "클린룸, 변압기, 차단기, 전동기, 인버터, 디스펜싱, MLCC, 냉장고, 오븐, 에어컨, 코팅" },
    { label: "에너지/환경", items: "풍력터빈, 태양광 발전, 조류발전, 보일러, 엔진, PPS, HRSG, SCR, 스크러버, 건조기" },
    { label: "기타", items: "정수장, 혼합기, 열교환기, 팬, 압축기, 터빈, 펌프, 온수롤, 화재" },
];
...
export default function ConsultIntroPage() {
    return (
        <PageLayout>
            ...
            <CtaButton href="/contact" variant="blue">프로젝트 문의하기</CtaButton>

            <div className="pt-14 mb-16">
                <SectionLabel>CFD 시뮬레이션</SectionLabel>
                <h2 className="text-white text-[32px] font-semibold tracking-tight leading-snug mb-6">
                    CFD 시뮬레이션을 통한<br />성능평가 / 진단 / 최적설계
                </h2>
                <p className="text-white/90 text-[17px] leading-[1.9] mb-5">
                ...
                <div className="relative w-full h-[400px] overflow-hidden border border-white/40 mb-8">
                ...
                <p className="text-white/90 text-[17px] leading-[1.9]">
            ...
            <div className="pt-14 mb-16">
                ...
                <p className="text-white text-[18px] leading-[1.9] mb-5">
                ...
                <p className="text-white/90 text-[17px] leading-[1.9] mb-8">
                ...
                <div className="relative w-full h-[340px] overflow-hidden border border-white/40 mb-10">
                    <Image src="/consult_intr/ec8aa4ed81aceba6b0ec83b7-2025-01-16-19-34-17.png" alt="DIY CFD 프로그램" fill className="object-cover" />
                </div>
                <p className="text-white/75 text-[14px] tracking-[0.15em] uppercase mb-4">개발 프로세스</p>
                <div className="flex flex-col">
                    {devSteps.map((s, i) => (
                        <div key={i} className="flex items-center gap-5 py-4 border-b border-white/40">
                            <span className="text-white/60 text-[13px] tracking-widest w-7 shrink-0">{String(i + 1).padStart(2, "0")}</span>
                            <span className="text-white text-[17px]">{s}</span>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div className="pt-14 mb-16">
                ...
                <div className="relative w-full h-[360px] overflow-hidden border border-white/40">
                    <Image src="/consult_intr/pod1.png" alt="POD 기반 실시간 시뮬레이터" fill className="object-cover" />
                    <span className="absolute bottom-3 left-4 text-white/70 text-[13px] tracking-[0.15em] uppercase">POD-based Real-time Simulator</span>
                </div>
            </div>

            <div className="pt-14 mb-16">
                <SectionLabel>영상계측 시스템</SectionLabel>
                <h2 className="text-white text-[32px] font-semibold tracking-tight leading-snug mb-6">영상계측 시스템 개발</h2>
                <p className="text-white/90 text-[17px] leading-[1.9] mb-5">
                ...
                <div className="relative w-full h-[360px] overflow-hidden border border-white/40">
                    ...
                    <span className="absolute bottom-3 left-4 text-white/70 text-[13px] tracking-[0.15em] uppercase">Vision-based 6-DOF Measurement System</span>
                </div>
            </div>

            <div className="pt-14 mb-16">
                <SectionLabel>HPC / Cloud</SectionLabel>
                <h2 className="text-white text-[32px] font-semibold tracking-tight leading-snug mb-6">HPC/Cloud 컨설팅</h2>
                <p className="text-white/90 text-[17px] leading-[1.9] mb-5">
                ...
                <div className="relative w-full h-[300px] overflow-hidden border border-white/40">
                    <Image src="/consult_intr/azure.jpg" alt="Launch BARAM on Azure" fill className="object-cover" />
                    <span className="absolute bottom-3 left-4 text-white/70 text-[13px] tracking-[0.15em] uppercase">Launch BARAM on Azure</span>
                </div>
            </div>
            ...
            <div className="pt-14">
                ...
                <div className="border border-white/40">
                    {industries.map((ind, i) => (
                        <div key={i} className={`flex ${i < industries.length - 1 ? "border-b border-white/40" : ""}`}>
                            <span className="text-white text-[16px] font-semibold tracking-wide w-40 shrink-0 px-5 py-4 border-r border-white/40 bg-white/5">{ind.label}</span>
                            <span className="text-white/85 text-[16px] leading-[1.8] px-6 py-4">{ind.items}</span>
                        </div>
                    ))}
                </div>
            </div>
