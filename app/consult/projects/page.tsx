...
const categories: Category[] = [
    ...
    {
        label: "자동차 / 철도",
        en: "Automotive & Railway",
        img: "/consult_perf/drivaer-13.png",
        more: true,
        projects: [
    ...
    {
        label: "조선 / 해양",
        en: "Shipbuilding & Marine",
        img: "/consult_perf/ed8c8ceb9e91-600x359.webp",
        more: true,
        projects: [
    ...
    },
    {
        label: "전기 / 전자",
        en: "Electronics",
        img: "/consult_perf/eb9494ec8aa4ed8e9cec8bb1.gif",
        more: true,
        projects: [
    ...
    },
    {
        ...
        img: "/consult_perf/shoe_closet_large_type2_wood_snf.webp",
        more: true,
        projects: [
    ...
    },
    {
        ...
        img: "/consult_perf/dam-1-600x305.webp",
        more: true,
        projects: [
    ...
    },
    {
        label: "기타",
        en: "Others",
        img: "/consult_perf/ebafb8eb9494ec96b41.gif",
        more: false,
        projects: [
            ...
            { title: "KR 구성품 중 영상 탐지/추적 S/W 프로그램 추가기능 개발", client: "경인테크", year: "2023" },
            ...
            { title: "계산과학공학 유동해석 커뮤니티 활성화를 위한 고급 콘텐츠 제작", client: "한국과학기술정보연구원", year: "2021" },
            { title: "EDISON 연구커뮤니티 활성화를 위한 오픈소스 계산 소프트웨어 OpenFOAM 설치 및 등록", client: "한국과학기술정보연구원", year: "2020" },
            { title: "영상추적 Software 개발", client: "경인테크", year: "2020" },
            { title: "계산과학플랫폼과 5호기 연동을 위한 기술 및 인터페이스 개발", client: "한국과학기술정보연구원", year: "2019" },
            { title: "KIMM-Flow 해석 모듈 추가 및 GUI 수정", client: "한국기계연구원", year: "2019" },
            { title: "열교환기 CFD 열유동해석 연구용역", client: "포항산업과학연구원", year: "2019" },
            { title: "OpenFOAM 기반의 CFD 프로그램 개발", client: "한국기계연구원", year: "2018" },
            { title: "Thermowell의 vortex shedding 현상 유동 해석", client: "두광MFG", year: "2018" },
            { title: "무격자 방식의 전산유체역학 해석 소프트웨어 개발 연구", client: "민군협력진흥원", year: "2018" },
            ...
            { title: "제품 공정 맞춤형 설계 자동화 시스템 개발", client: "한국과학기술정보연구원", year: "2015" },
            { title: "고온밸브 최적형상 설계기법 연구", client: "한밭대", year: "2015" },
            { title: "제독 대상공간의 공기유동 해석", client: "삼양화학", year: "2014" },
            { title: "오픈폼 매뉴얼 제작", client: "한국과학기술정보연구원", year: "2014" },
            { title: "건식 제독 챔버 내 가스 유동 해석", client: "삼양화학", year: "2012" },
            { title: "압축기/터빈 해석 프로그램 개발", client: "STX종합기술원", year: "2012" },
        ],
    },
];
            ...
            <div className="max-w-[800px] mx-auto px-10 pt-40 pb-40">
                ...
                {categories.map((cat, ci) => (
                    <div key={ci} className="border-t border-white/20 pt-14 mb-16">
                        ...
                        <h2 className="text-white text-[24px] font-medium tracking-tight mb-8">{cat.label}</h2>

                        <div className="relative w-full h-[240px] overflow-hidden border border-white/10 mb-10">
                            <Image
                                src={cat.img}
                                alt={cat.label}
                                fill
                        ...
                        <div className="flex flex-col">
                            {cat.projects.map((p, pi) => (
                                <div key={pi} className="flex items-start gap-6 py-3.5 border-b border-white/10">
                                    <span className="text-white/25 text-[11px] tracking-widest w-5 pt-0.5 shrink-0">
                                        {String(pi + 1).padStart(2, "0")}
                                    </span>
                                    <span className="text-white text-[14px] leading-[1.7] flex-1">{p.title}</span>
                                    <div className="flex flex-col items-end shrink-0 gap-0.5 pt-0.5">
                                        <span className="text-white/50 text-[12px] tracking-wide whitespace-nowrap">{p.client}</span>
                                        <span className="text-white/30 text-[11px] tracking-widest">{p.year}</span>
                                    </div>
                                </div>
                            ))}
                            ...
                            {cat.more && (
                                <div className="py-4">
                                    <span className="text-white/25 text-[12px] tracking-[0.2em]">— 외 다수</span>
                                </div>
                            )}
                        </div>
                    </div>
